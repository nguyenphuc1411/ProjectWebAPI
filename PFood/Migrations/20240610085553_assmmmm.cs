...
{
    /// <inheritdoc />
    public partial class assmmmm : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNumber = table.Column<string>(type: "varchar(13)", maxLength: 11, nullable: true),
                    DOB = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Address = table.Column<string>(type: "Varchar(255)", nullable: true),
                    Avartar = table.Column<string>(type: "varchar(255)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Discount = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    ImageMain = table.Column<string>(type: "varchar(255)", nullable: false),
                    ImageFirst = table.Column<string>(type: "varchar(255)", nullable: true),
                    ImageSecond = table.Column<string>(type: "varchar(255)", nullable: true),
                    ImageThree = table.Column<string>(type: "varchar(255)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryAddress = table.Column<string>(type: "nvarchar(255)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "d1369062-31c8-46d0-9fe4-4afb844b9c1c", null, "Admin", "ADMIN" },
                    { "dd9eb70e-9ad7-41f9-8dfe-c366828c569c", null, "Customer", "CUSTOMER" }
                });
